        ...
        <div class="order-form">
                ...
                <div class="form-spoiler"> 
                    ...
                    <div class="form-box__str pageparams">
                        ...
                        <span class="wpcf7-form-control-wrap number-start">
                            <input type="number" name="<?php echo $re_data['form']['name_fields']['number_start']; ?>" value="2" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-number form-box__str__number" min="0" max="99" step="1" onclick="this.select();" aria-invalid="false">
                        </span>
                        <label class="form-box__str__label">до</label>
                        <span class="wpcf7-form-control-wrap number-end">
                            <input type="number" name="<?php echo $re_data['form']['name_fields']['number_end']; ?>" value="5" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-number form-box__str__number" min="0" max="99" step="1" onclick="this.select();" aria-invalid="false">
                        </span>
                    </div>
                    <div class="form-box__str pageparams">
                        <label class="form-box__str__label">Уникальность
                            <span class="wpcf7-form-control-wrap unicum">
                                <input type="number" name="<?php echo $re_data['form']['name_fields']['unical_procent']; ?>" value="80" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-number form-box__str__number" min="0" max="99" step="5" onclick="this.select();" aria-invalid="false">
                            </span>
                            % &nbsp;</label>
            ...
            <div class="form-hidden">
                ...
                <div class="form-box__str">
                    ...
                    <input type="submit" value="Перейти в заказ" class="wpcf7-form-control wpcf7-submit form__button essay">
                </div>
