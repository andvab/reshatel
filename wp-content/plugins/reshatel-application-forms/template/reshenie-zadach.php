        ...
        <div class="order-form">
            <div class="top-hidden">
                ...
                <div class="form-box__str">
                    <label class="form-box__str__label">Решение предоставить *</label>
            ...
            <div class="form-hidden">
                ...
                <div class="form-box__str">
                    ...
                    <input type="submit" value="Перейти в заказ" class="wpcf7-form-control wpcf7-submit form__button tasks">
                </div>
