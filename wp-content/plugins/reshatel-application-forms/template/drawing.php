        ...
        <div class="order-form">
            <div class="top-hidden">
                <div class="form-group no-files form-box__str">
                    <label class="form-box__str__label">Задание</label>
                ...
                <div class="form-box__str">
                    ...
                    <span class="wpcf7-form-control-wrap subject"><input type="text" name="<?php echo $re_data['form']['name_fields']['subject']; ?>" value="<?= $subject ?>" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required form-box__str__i-text" aria-required="true" required aria-invalid="false"></span>
                </div>

                <div class="form-box__str">
                    <label class="form-box__str__label">Пояснения</label>
                    <span class="wpcf7-form-control-wrap comment">
                        <textarea name="<?php echo $re_data['form']['name_fields']['comment']; ?>" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea form-box__str__textarea" aria-invalid="false" placeholder="Номер задания, вариант, пожелания, комментарии..." onblur="this.style.height = '100px'"></textarea>
                    </span>
                </div>
            ...
            <div class="form-hidden">
                ...
                <div class="form-box__str">
                    ...
                    <input type="submit" value="Перейти в заказ" class="wpcf7-form-control wpcf7-submit form__button drawing">
                </div>
