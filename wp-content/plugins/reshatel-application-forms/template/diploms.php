        ...
        <div class="order-form">
            <div class="top-hidden">
                ...
                <div class="form-spoiler">  
                    ...
                    <div class="form-box__str pageparams">
                        <label class="form-box__str__label">Страниц от</label>
                        <span class="wpcf7-form-control-wrap number-start">
                            <input type="number" name="<?php echo $re_data['form']['name_fields']['number_start']; ?>" value="40" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-number form-box__str__number" min="0" max="199" step="5" onclick="this.select();" aria-invalid="false">
                        </span>
                        <label class="form-box__str__label">до</label>
                        <span class="wpcf7-form-control-wrap number-end">
                            <input type="number" name="<?php echo $re_data['form']['name_fields']['number_end']; ?>" value="50" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-number form-box__str__number" min="0" max="199" step="5" onclick="this.select();" aria-invalid="false">
                        </span>
                    </div>
                    <div class="form-box__str pageparams">
                        <label class="form-box__str__label">Уникальность
                            <span class="wpcf7-form-control-wrap unicum">
                                <input type="number" name="<?php echo $re_data['form']['name_fields']['unical_procent']; ?>" value="70" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-number form-box__str__number" min="0" max="99" step="5" onclick="this.select();" aria-invalid="false">
                            </span>
                            % &nbsp;</label>
                    ...
                    <div class="form-box__str exp">
                        ...
                        <span class="wpcf7-form-control-wrap comment">
                            <textarea name="<?php echo $re_data['form']['name_fields']['comment']; ?>" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea form-box__str__textarea" aria-invalid="false" placeholder="Вся необходимая информация по работе" onblur="this.style.height = '100px'"></textarea>
                        </span>
                    </div>
            ...
            <div class="form-hidden">
                ...
                <div class="form-box__str">
                    ...
                    <input type="submit" value="Перейти в заказ" class="wpcf7-form-control wpcf7-submit form__button diplom">
                </div>
