        ...
        <div class="order-form">
                ...
                <div class="form-spoiler">    
                    ...
                    <div class="form-box__str pageparams">
                        ...
                        <span class="wpcf7-form-control-wrap number-start">
                            <input type="number" name="<?php echo $re_data['form']['name_fields']['number_start']; ?>" value="20" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-number form-box__str__number" min="0" max="199" step="5" onclick="this.select();" aria-invalid="false">
                        </span>
                        <label class="form-box__str__label">до</label>
                        <span class="wpcf7-form-control-wrap number-end">
                            <input type="number" name="<?php echo $re_data['form']['name_fields']['number_end']; ?>" value="25" class="wpcf7-form-control wpcf7-number wpcf7-validates-as-number form-box__str__number" min="0" max="199" step="5" onclick="this.select();" aria-invalid="false">
                        </span>
                    </div>
                    <div class="form-box__str pageparams">
                    ...
                    <div class="form-box__str exp">
                        ...
                        <span class="wpcf7-form-control-wrap comment">
                            <textarea name="<?php echo $re_data['form']['name_fields']['comment']; ?>" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea form-box__str__textarea" aria-invalid="false" placeholder="Организация, сроки прохождения практики и прочая необходимая информация" onblur="this.style.height = '100px'"></textarea>
                        </span>
                    </div>
            ...
            <div class="form-hidden">
                ...
                <div class="form-box__str">
                    ...
                    <input type="submit" value="Перейти в заказ" class="wpcf7-form-control wpcf7-submit form__button practice">
                </div>
