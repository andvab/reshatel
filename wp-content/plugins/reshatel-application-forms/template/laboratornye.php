        ...
        <div class="order-form">
            <div class="top-hidden">
                ...
                <div class="form-box__str">
                    ...
                    <span class="wpcf7-form-control-wrap comment">
                        <textarea name="<?php echo $re_data['form']['name_fields']['comment']; ?>" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea form-box__str__textarea" aria-invalid="false" placeholder="Уточните вариант, пожелания, комментарии..." onblur="this.style.height = '100px'"></textarea>
                    </span>
                </div>
            ...
            <div class="form-hidden">
                ...
                <div class="form-box__str">
                    ...
                    <input type="submit" value="Перейти в заказ" class="wpcf7-form-control wpcf7-submit form__button laboratornaya">
                </div>
