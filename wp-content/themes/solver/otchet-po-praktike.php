<?
/**
 * Template Name: Отчеты по практике
 *
 * @package WordPress
 * @subpackage Solver
 * @since Solver 1.0
...
<div id="article" class="container" style="margin-top:20px">
    ...
    <div class="general-form container">
        ...
        <noindex>
            <?= do_shortcode('[reshatel_form name=otchety-po-praktike]'); ?>
        </noindex>
    </div>

    <div class="general-how-much container">
        <div class="general-title">Сколько стоит отчет по практике?</div>
        <?php
    ...
    <div class="general-prob container">
        <?php if (have_rows('how_prob')): ?>
            <div class="general-title">Практика по специальностям</div>
            <?
    ...
    <div class="last-orders container">
        <noindex>
            ...
            <div class="owl-carousel owl-theme lo-container" data-type="11">
    ...
    <div class="general-middle container">
        <div class="general-title">отчеты по практике</div>
