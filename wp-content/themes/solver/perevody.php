...
<div id="article" class="container" style="margin-top:20px">
    ...
    <div class="general-form container">
        ...
        <noindex>
            <?= do_shortcode('[reshatel_form name=perevody]'); ?>
        </noindex>
    </div>

    <div class="general-how-much container">
        <div class="general-title">сколько стоит перевод?</div>
        <?php
    ...
    <? if (have_rows('how_prob')): ?>
        <div class="general-prob container">
            <div class="general-title">Какие тексты мы переводим?</div>
            <? while (have_rows('how_prob')) : the_row(); ?>

                <a class="prob-block" href="<? the_sub_field('prob_link'); ?>">
                    <figure style="background-image: url(<? the_sub_field('prob_image'); ?>);"></figure>

                    <div class="text-part">
                        <? the_sub_field('prob_text'); ?>
                    </div>
                </a>
    ...
    <div class="last-orders container">
        <noindex>
            <div class="general-title">Примеры работ</div>
            <div class="owl-carousel owl-theme lo-container" data-type="12">
    ...
    <div class="general-middle container">
        <div class="general-title">Переводы на заказ</div>
