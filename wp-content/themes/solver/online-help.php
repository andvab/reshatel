...
<div id="article" class="container" style="margin-top:20px">
    ...
    <div class="general-form container">
        ...
        <noindex>
            <?= do_shortcode('[reshatel_form name=online-pomoshh]'); ?>
        </noindex>
    </div>

    <div class="general-how-much container">
        <div class="general-title">сколько стоит онлайн помощь?</div>
        <?php
    ...
    <div class="general-prob container">
        <div class="general-title">Кейсы выполненных заказов</div>
        <?php
    ...
    <div class="last-orders container">
        <noindex>
            ...
            <div class="owl-carousel owl-theme lo-container" data-type="6">
    ...
    <div class="general-middle container">
        <div class="general-title">помощь на экзамене</div>
