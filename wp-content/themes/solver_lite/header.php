...
// Далее можно перечислять нужные виджеты ВКонтакте
    ...
    <div class="row">
      <div class="span8">
	    ...
	    <? if(!is_front_page() || is_paged())
	         echo "<a href=\"/\"><img src=\" $site_logo_thumb \" alt=\"Решатель - консультации, решение задач, контрольные\"></a>";
	       else
	         echo "<img src=\" $site_logo_thumb \" alt=\"Решатель - консультации, решение задач, контрольные\">";
	    ?>
          </div>
          <? endif ?>
          <noindex>
  ...
  <div id="main-menu" class="container" style="margin-bottom: 30px;">
