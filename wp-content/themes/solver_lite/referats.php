...
<div id="article" class="container" style="margin-top:20px">
    ...
    <div class="general-form container">
        <noindex>
            <?= do_shortcode('[reshatel_form name=referats]'); ?>
        </noindex>
    </div>

    <div class="general-how-much container">
        <div class="general-title">Сколько стоит реферат?</div>
        <?php
    ...
    <div class="general-prob container">
        <?php if (have_rows('how_prob')): ?>
            <div class="general-title">Рефераты по предметам</div>
            <?
    ...
    <div class="last-orders container">
        <noindex>
            ...
            <div class="owl-carousel owl-theme lo-container" data-type="5">
    ...
    <div class="general-middle container">
        <div class="general-title">рефераты на заказ</div>
